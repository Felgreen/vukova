...
const GridLayout = () => {
  ...
  return (
    <>
      <div className="grid md:hidden place-items-center min-h-screen text-black ">
         ...
         opacity-70 transition-opacity group-hover:opacity-50"
              ...
              <div className="relative p-4 ">
                <motion.p
                  ...
                  className="text-3xl font-medium uppercase tracking-widest font-montBold text-black underline decoration-[#e33d20] "
                >
                  {t.grid.title1}
                </motion.p>
                ...
                <div className="">
                  <div className="translate-y-32">
                    <motion.p
                      variants={pAnimate}
                      className="text-base text-black  font-montBold"
                    >
                      {t.grid.desc1}
                    </motion.p>
                  </div>
